...
namespace UiDesktopApp2.Migrations
{
    ...
    [Migration("20250206092046_tracking_precision")]
    partial class tracking_precision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UiDesktopApp2.DataAccess.Entities.ResultImageVariantTime", b =>
                {
                    b.HasOne("UiDesktopApp2.DataAccess.Entities.ImageVariant", "ImageVariant")
                        .WithMany()
                        .HasForeignKey("ImageVariantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UiDesktopApp2.DataAccess.Entities.Result", "Result")
                        .WithMany("ImageVariantTimes")
                        .HasForeignKey("ResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UiDesktopApp2.DataAccess.Entities.Result", b =>
                {
                    ...
                    b.Navigation("ImageVariantTimes");
                });
